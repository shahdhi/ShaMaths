...
import { CheckCircle, Home, Sparkles, Download } from 'lucide-react';
          ...
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6 mb-6">
              <div className="flex items-center justify-center mb-3">
                ...
                <h3 className="font-semibold text-green-800 text-lg">Download Receipt</h3>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center justify-center space-x-2 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 font-medium w-full"
              >
